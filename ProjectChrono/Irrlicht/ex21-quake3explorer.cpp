...
void GameData::setDefault ()
{
	...
	CurrentArchiveList.push_back ( StartupDir + "/opt/hamzstlib/Physics/irrlicht-1.8.5/media/" );
	...
	CurrentArchiveList.push_back(StartupDir + "/opt/hamzstlib/Physics/irrlicht-1.8.5/media/map-20kdm2.pk3");
}
