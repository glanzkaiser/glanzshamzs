...
int main()
{
	...
	//Load model
	IAnimatedMesh *model = smgr->getMesh("/opt/hamzstlib/Physics/irrlicht-1.8.5/media/sydney.md2");
	if (!model)
		return 1;
	...
	if (model_node)
	{
		ITexture *texture = driver->getTexture("/opt/hamzstlib/Physics/irrlicht-1.8.5/media/sydney.bmp");
