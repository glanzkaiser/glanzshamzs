...
int main()
{
	...
	*/
	...
	case video::EDT_DIRECT3D8:
		psFileName = "/opt/hamzstlib/Physics/irrlicht-1.8.5/media/d3d8.psh";
		vsFileName = "/opt/hamzstlib/Physics/irrlicht-1.8.5/media/d3d8.vsh";
		break;
	case video::EDT_DIRECT3D9:
		if (UseHighLevelShaders)
		{
			// Cg can also handle this syntax
			psFileName = "/opt/hamzstlib/Physics/irrlicht-1.8.5/media/d3d9.hlsl";
			vsFileName = psFileName; // both shaders are in the same file
		}
		else
		{
			psFileName = "/opt/hamzstlib/Physics/irrlicht-1.8.5/media/d3d9.psh";
			vsFileName = "/opt/hamzstlib/Physics/irrlicht-1.8.5/media/d3d9.vsh";
		}
		break;
	...
	case video::EDT_OPENGL:
		if (UseHighLevelShaders)
		{
			if (!UseCgShaders)
			{
				psFileName = "/opt/hamzstlib/Physics/irrlicht-1.8.5/media/opengl.frag";
				vsFileName = "/opt/hamzstlib/Physics/irrlicht-1.8.5/media/opengl.vert";
			}
			else
			{
		...
		{
			psFileName = "/opt/hamzstlib/Physics/irrlicht-1.8.5/media/opengl.psh";
			vsFileName = "/opt/hamzstlib/Physics/irrlicht-1.8.5/media/opengl.vsh";
		}
		break;
	}
	...
	*/
	...
	node->setMaterialTexture(0, driver->getTexture("/opt/hamzstlib/Physics/irrlicht-1.8.5/media/wall.bmp"));
	...
	*/
	...
	smgr->addSkyBoxSceneNode(
		driver->getTexture("/opt/hamzstlib/Physics/irrlicht-1.8.5/media/irrlicht2_up.jpg"),
		driver->getTexture("/opt/hamzstlib/Physics/irrlicht-1.8.5/media/irrlicht2_dn.jpg"),
		driver->getTexture("/opt/hamzstlib/Physics/irrlicht-1.8.5/media/irrlicht2_lf.jpg"),
		driver->getTexture("/opt/hamzstlib/Physics/irrlicht-1.8.5/media/irrlicht2_rt.jpg"),
		driver->getTexture("/opt/hamzstlib/Physics/irrlicht-1.8.5/media/irrlicht2_ft.jpg"),
		driver->getTexture("/opt/hamzstlib/Physics/irrlicht-1.8.5/media/irrlicht2_bk.jpg"));
