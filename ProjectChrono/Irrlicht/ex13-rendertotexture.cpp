...
int main()
{
	...
	*/
	...
	scene::IAnimatedMeshSceneNode* fairy = smgr->addAnimatedMeshSceneNode(
		smgr->getMesh("/opt/hamzstlib/Physics/irrlicht-1.8.5/media/faerie.md2"));

	if (fairy)
	{
		fairy->setMaterialTexture(0,
				driver->getTexture("/opt/hamzstlib/Physics/irrlicht-1.8.5/media/faerie2.bmp")); // set diffuse texture
