...
int main()
{
	...
	*/
	...
	scene::IAnimatedMesh* mesh = smgr->getMesh("/opt/hamzstlib/Physics/irrlicht-1.8.5/media/room.3ds");
	...
	node->setMaterialTexture(0, driver->getTexture("/opt/hamzstlib/Physics/irrlicht-1.8.5/media/wall.jpg"));
	...
	*/
	...
	node->setMaterialTexture(0, driver->getTexture("/opt/hamzstlib/Physics/irrlicht-1.8.5/media/stones.jpg"));
	node->setMaterialTexture(1, driver->getTexture("/opt/hamzstlib/Physics/irrlicht-1.8.5/media/water.jpg"));
	...
	*/
	...
	node->setMaterialTexture(0, driver->getTexture("/opt/hamzstlib/Physics/irrlicht-1.8.5/media/particlewhite.bmp"));
	...
	*/
	...
	ps->setMaterialTexture(0, driver->getTexture("/opt/hamzstlib/Physics/irrlicht-1.8.5/media/fire.bmp"));
	...
	*/
	...
	if (n)
	{
		...
		{
			core::stringc tmp;
			tmp = "/opt/hamzstlib/Physics/irrlicht-1.8.5/media/portal";
			tmp += g;
			tmp += ".bmp";
	...
	*/
	...
	mesh = smgr->getMesh("/opt/hamzstlib/Physics/irrlicht-1.8.5/media/dwarf.x");
