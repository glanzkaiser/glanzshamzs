...
public:
		...
		gui::IGUIEnvironment* env, video::IVideoDriver* driver)
	{
		...
		gui::IGUIFont* font = env->getFont("/opt/hamzstlib/Physics/irrlicht-1.8.5/media/fonthaettenschweiler.bmp");
		if (font)
			skin->setFont(font);
...
int main()
{
	...
	*/
	...
	// add irrlicht logo
	env->addImage(driver->getTexture("/opt/hamzstlib/Physics/irrlicht-1.8.5/media/irrlichtlogo3.png"),
	...
	*/
	...
	scene::IAnimatedMesh* roomMesh = smgr->getMesh("/opt/hamzstlib/Physics/irrlicht-1.8.5/media/room.3ds");
	...
	if (roomMesh)
	{
		...
		*/
		...
		video::ITexture* normalMap =
			driver->getTexture("/opt/hamzstlib/Physics/irrlicht-1.8.5/media/rockwall_height.bmp");
...
/*
		...
		video::ITexture* normalMap =
			driver->getTexture("/opt/hamzstlib/Physics/irrlicht-1.8.5/media/rockwall_NRM.tga");
*/
		/*
		...
		*/
		...
		room->setMaterialTexture(0,
				driver->getTexture("/opt/hamzstlib/Physics/irrlicht-1.8.5/media/rockwall.jpg"));
	...
	*/
	...
	scene::IAnimatedMesh* earthMesh = smgr->getMesh("/opt/hamzstlib/Physics/irrlicht-1.8.5/media/earth.x");
	if (earthMesh)
	{
		...
		video::ITexture* earthNormalMap = driver->getTexture("/opt/hamzstlib/Physics/irrlicht-1.8.5/media/earthbump.jpg");
		if (earthNormalMap)
		{
	...
	*/
	...
	bill->setMaterialTexture(0, driver->getTexture("/opt/hamzstlib/Physics/irrlicht-1.8.5/media/particlegreen.jpg"));
	...
	*/
	...
	bill->setMaterialFlag(video::EMF_ZWRITE_ENABLE, false);
	bill->setMaterialType(video::EMT_TRANSPARENT_ADD_COLOR);
	bill->setMaterialTexture(0, driver->getTexture("/opt/hamzstlib/Physics/irrlicht-1.8.5/media/particlered.bmp"));
	...
	ps->setMaterialTexture(0, driver->getTexture("/opt/hamzstlib/Physics/irrlicht-1.8.5/media/fireball.bmp"));
