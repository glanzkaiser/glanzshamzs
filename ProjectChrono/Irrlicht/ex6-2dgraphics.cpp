...
int main()
{
	...
	*/
	video::ITexture* images = driver->getTexture("/opt/hamzstlib/Physics/irrlicht-1.8.5/media/2ddemo.png");
	...
	*/
	...
	gui::IGUIFont* font2 =
		device->getGUIEnvironment()->getFont("/opt/hamzstlib/Physics/irrlicht-1.8.5/media/fonthaettenschweiler.bmp");
