...
IrrlichtDevice *startup()
{
	...
	// add irrlicht logo
	guienv->addImage(driver->getTexture("/opt/hamzstlib/Physics/irrlicht-1.8.5/media/irrlichtlogo3.png"),
...
int example_terrain()
{
	...
	*/
	...
	//set other font
	//env->getSkin()->setFont(env->getFont("/opt/hamzstlib/Physics/irrlicht-1.8.5/media/fontlucida.png"));
	...
	*/
	...
	scene::ITerrainSceneNode* terrain = smgr->addTerrainSceneNode(
		"/opt/hamzstlib/Physics/irrlicht-1.8.5/media/terrain-heightmap.bmp",
		0,					// parent node
		-1,					// node id
	...
	if ( terrain )
	{
		...
		terrain->setMaterialTexture(0,
				driver->getTexture("/opt/hamzstlib/Physics/irrlicht-1.8.5/media/terrain-texture.jpg"));
		terrain->setMaterialTexture(1,
				driver->getTexture("/opt/hamzstlib/Physics/irrlicht-1.8.5/media/detailmap3.jpg"));
	...
	*/
	...
	scene::ISceneNode* skydome=smgr->addSkyDomeSceneNode(driver->getTexture("/opt/hamzstlib/Physics/irrlicht-1.8.5/media/skydome.jpg"),16,8,0.95f,2.0f);
