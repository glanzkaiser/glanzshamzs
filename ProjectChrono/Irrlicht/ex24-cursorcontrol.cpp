...
int main()
{
	...
	array< io::path > files;
	files.push_back( io::path("/opt/hamzstlib/Physics/irrlicht-1.8.5/media/icon_crosshairs16x16bw1.png") );
	files.push_back( io::path("/opt/hamzstlib/Physics/irrlicht-1.8.5/media/icon_crosshairs16x16bw2.png") );
	files.push_back( io::path("/opt/hamzstlib/Physics/irrlicht-1.8.5/media/icon_crosshairs16x16bw3.png") );
	files.push_back( io::path("/opt/hamzstlib/Physics/irrlicht-1.8.5/media/icon_crosshairs16x16bw3.png") );
	files.push_back( io::path("/opt/hamzstlib/Physics/irrlicht-1.8.5/media/icon_crosshairs16x16bw2.png") );
	...
	spriteCol.SpriteId = AddAnimatedIconToSpriteBank( SpriteBankIcons, driver, io::path("/opt/hamzstlib/Physics/irrlicht-1.8.5/media/icon_crosshairs16x16col.png"), iconRects, 200 );
	...
	spriteNonAnimated.SpriteId = AddIconToSpriteBank( SpriteBankIcons, driver, io::path("/opt/hamzstlib/Physics/irrlicht-1.8.5/media/icon_crosshairs16x16col.png"), rectIcon );
