...
//#define SHOW_SHADER_NAME
	...
	#define QUAKE3_STORAGE_1	"/opt/hamzstlib/Physics/irrlicht-1.8.5/media/map-20kdm2.pk3"
...
int IRRCALLCONV main(int argc, char* argv[])
{
	...
	*/
	...
	device->getFileSystem()->addFileArchive("/opt/hamzstlib/Physics/irrlicht-1.8.5/media/");
	...
	*/
	if ( mesh )
	{
		...
		gui::IGUIFont *font = device->getGUIEnvironment()->getFont("/opt/hamzstlib/Physics/irrlicht-1.8.5/media/fontlucida.png");
		u32 count = 0;
#endif
