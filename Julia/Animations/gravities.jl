...
planets = [
    Planet(1, "Mischkra", 3.7, "snow4")
    Planet(2, "Caldraz", 8.9, "navajowhite")
    Planet(3, "Vanille", 9.8, "lightskyblue")
    Planet(4, "Lucrif", 1.6, "gainsboro")
    Planet(5, "Lasthrim", 3.7, "orangered")
    Planet(6, "Zalsvik", 23.1, "olive")
    Planet(7, "Hamzst", 9, "burlywood")
    Planet(8, "Glanz", 8.7, "cyan3")
    Planet(9, "Freya", 11, "dodgerblue")
    Planet(10, "Zalsimourg", 0.7, "rosybrown4")
]
