...
# Set variables
export TRILINOS_ROOT="/opt/hamzstlib/trilinos/lib"
...
# Configure
cmake -H"${KRATOS_SOURCE}" -B"${KRATOS_BUILD}/${KRATOS_BUILD_TYPE}" -DUSE_MPI=OFF -DMETIS_ROOT_DIR=/opt/hamzstlib/lib -DTRILINOS_ROOT_DIR=opt/hamzstlib/trilinos/lib -DUSE_TRIANGLE_NONFREE_TPL=ON -DUSE_EIGEN_MKL=OFF
