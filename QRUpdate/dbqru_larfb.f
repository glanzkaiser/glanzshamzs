      SUBROUTINE DBQRU_LARFB( SIDE, TRANS, M, N, K, V, LDV, T, LDT, 
     $                        C, LDC, D, LDD, WORK, LDWORK )
      IMPLICIT NONE
*
*     This is a modification of the LAPACK routine DLARFB.
*
*     .. Scalar Arguments ..
...
*     ..
*     .. Array Arguments ..
      DOUBLE PRECISION   C( LDC, * ), D( LDD, * ), T( LDT, * ),
     $                   V( LDV, * ), WORK( LDWORK, * )
*     ..
*
*  Purpose
*  =======
*
*  DBQRU_LARFB applies a real block reflector H or its transpose H',
*  as generated by the routine DBQRU_LARFT to an (k+m) by n matrix
...
*
   ...
   10    CONTINUE
*
         CALL DGEMM( 'Transpose', 'No transpose', N, K, M, ONE,
     $               D, LDD, V, LDV, ONE, WORK, LDWORK )
*
*        W := W * T'  or  W * T
*
...
*        D := D - V * W'
*
         CALL DGEMM( 'No transpose', 'Transpose', M, N, K, -ONE,
     $               V, LDV, WORK, LDWORK, ONE, D, LDD )
*
...
*        W := C + D * V  (stored in WORK)
   ...
   40    CONTINUE
         CALL DGEMM( 'No transpose', 'No transpose', M, K, N, ONE, D,
...
*        D := D - W * V'
*
         CALL DGEMM( 'No transpose', 'Transpose', M, N, K, -ONE, WORK,
     $               LDWORK, V, LDV, ONE, D, LDD )
      END IF
*
      RETURN
*
