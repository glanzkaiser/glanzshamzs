...
/* Define if experimental Ifpack2 code that uses KokkosKernels is enabled. */
#define HAVE_IFPACK2_EXPERIMENTAL_KOKKOSKERNELS_FEATURES
...
/* #undef HAVE_IFPACK2_BLOCKTRIDICONTAINER_TIMERS */

/* #undef HAVE_IFPACK2_BLOCKTRIDICONTAINER_SMALL_SCALAR */
...
/* Define if we have AztecOO */
#define HAVE_IFPACK2_AZTECOO

/* Define if we have Epetra */
#define HAVE_IFPACK2_EPETRA
...
#define HAVE_IFPACK2_ZOLTAN2CORE
#ifdef HAVE_IFPACK2_ZOLTAN2CORE
#  define HAVE_IFPACK2_ZOLTAN2
#endif

/* Define if we have ShyLU/HTS */
#define HAVE_IFPACK2_SHYLU_NODEHTS
