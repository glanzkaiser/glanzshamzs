...
#ifndef EPETRAEXT_DEPRECATED_MSG
#  if (__GNUC__ > 4 || (__GNUC__ == 4 && __GNUC_MINOR__ >= 5))
#    define EPETRAEXT_DEPRECATED_MSG(MSG)  __attribute__((__deprecated__ (#MSG) ))
#  elif (__GNUC__ > 3 || (__GNUC__ == 3 && __GNUC_MINOR__ >= 1))
#    define EPETRAEXT_DEPRECATED_MSG(MSG)  __attribute__((__deprecated__))
#  else
